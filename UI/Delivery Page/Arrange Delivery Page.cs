...
namespace UI.Delivery_Page {
    public partial class Arrange_Delivery_Page : Form {
        ...
        private void btn_unschedule_Click(object sender, EventArgs e) {
            ...
            MySqlCommand cmd_get_Id = new MySqlCommand("SELECT dts.Delivery_TeamID FROM `delivery_team_staff` AS dts, `delivery` AS d WHERE d.OrderID = '" + lb_scheduled_features.Text + "' AND dts.Delivery_TeamID = d.Delivery_TeamID", conn);
        ...
        private void btn_schedule_Click(object sender, EventArgs e) {
            ...
            MySqlCommand cmd_to_delivery = new MySqlCommand("UPDATE `delivery` AS d SET d.Delivery_TeamID = '" + lb_unscheduled_team.Text + "' WHERE " + "d.OrderID = '" + lb_order.Text + "';", conn);
