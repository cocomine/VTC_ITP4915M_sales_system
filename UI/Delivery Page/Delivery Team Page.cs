...
namespace UI.Delivery_Page {
    public partial class Delivery_Team_Page : Form {
        ...
        private void Delivery_Page_Load(object sender, EventArgs e) {
            ...
            MySqlCommand cmd_order = new MySqlCommand("SELECT * FROM `delivery` AS d, `customer` AS c " + "WHERE c.CustomerID = d.CustomerID AND d.Status = '1';", conn);
        ...
        private void btn_complete_Click(object sender, EventArgs e) {
            ...
            MySqlCommand update_dTeamStatus = new MySqlCommand("UPDATE `delivery_team` AS ds SET ds.Status = '0' " + "WHERE d.TeamID = '" + dTeamID + "';", conn);
            ...
            try {
                update_dTeamStatus.ExecuteNonQuery();
            } catch (MySqlException ex) {
                MessageBox.Show(ex.Message);
            }
